...
export class Backend implements backendInterface {
    ...
    async analyzeSkillGap(arg0: string, arg1: string): Promise<SkillGapResult> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeSkillGap(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async saveAnalysis(arg0: string, arg1: string, arg2: SkillGapResult): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveAnalysis(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
